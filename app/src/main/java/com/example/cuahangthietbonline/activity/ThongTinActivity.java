...
import com.example.cuahangthietbonline.databinding.ActivityThongTinBinding;
...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        LatLng AnKhangComputer = new LatLng(21.014043, 105.819290);
        mMap.addMarker(new MarkerOptions().position(AnKhangComputer).title("Lưu Ly Store").snippet("210 Thái Hà, Trung Liệt, Đống Đa, Hà Nội").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(AnKhangComputer).zoom(90).build();
